...
function (pvs_studio_add_target)
    ...
    pvs_default(PVS_STUDIO_CFG_TEXT "analysis-mode=31")
    pvs_default(PVS_STUDIO_CONFIG "${CMAKE_BINARY_DIR}/PVS-Studio.cfg")
    pvs_default(PVS_STUDIO_C_FLAGS "")
    pvs_default(PVS_STUDIO_CXX_FLAGS "")
    pvs_default(PVS_STUDIO_TARGET "pvs")
    pvs_default(PVS_STUDIO_LOG "PVS-Studio.log")
    ...
    if (WIN32)
        ...
        pvs_default(PVS_STUDIO_BIN "CompilerCommandsAnalyzer.exe")
        pvs_default(PVS_STUDIO_CONVERTER "HtmlGenerator.exe")
    else ()
        pvs_default(PVS_STUDIO_BIN "pvs-studio-analyzer")
        pvs_default(PVS_STUDIO_CONVERTER "plog-converter")
    endif ()
    ...
    pvs_default(PVS_STUDIO_MODE "GA:1,2")
    pvs_default(PVS_STUDIO_PREPROCESSOR "${DEFAULT_PREPROCESSOR}")
    if (WIN32)
        pvs_default(PVS_STUDIO_PLATFORM "x64")
    else ()
        pvs_default(PVS_STUDIO_PLATFORM "linux64")
    endif ()
